    ...
    private void setDialog() {
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    case 0:
                        Toast.makeText(MapActivity.this, "出发地点", Toast.LENGTH_SHORT).show();
                        break;
                    case 1:
                        Toast.makeText(MapActivity.this, "查询地点", Toast.LENGTH_SHORT).show();
                        break;
                }
            }
        });
    ...
    public void doClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.rb_didi_message:
                intent = new Intent(MapActivity.this, MessageActivity.class);
                startActivity(intent);
                break;
